...
def instantiate_model_and_tokenizer(
        ...
        raw_graph = False,
        dep_head_number = None,
        normal_head_number = None,
        dep_layer_begin_index = None,
        dep_layer_end_index = None,
        strategy = None,
        data_type = None,
        node_dropping = None,
):
    ...
    config.dep_head_number = dep_head_number
    config.normal_head_number = normal_head_number
    config.dep_layer_begin_index = dep_layer_begin_index
    config.dep_layer_end_index = dep_layer_end_index
    config.strategy = strategy
    config.node_dropping = node_dropping
